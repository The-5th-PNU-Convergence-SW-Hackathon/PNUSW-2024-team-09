...
|---------------------------------|----------------|--------------------------|--------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|----------|------------|---|
| 로그인                          | 학생로그인     | 회원관리                 | 아이디(학번)입력                                                                                 | 부산대와 연동 (학번/비번) 틀릴 경우 "아이디와 비밀번호가 맞는지 확인해주세요" 띄우기 맞을 경우 홈 화면으로 이동 | 0        | 0          |   |
|                                 |                |                          | 비밀번호입력                                                                                     |                                                                                                                 | 0        | 0          |   |
|                                 | 사업자로그인   |                          | 아이디(전화번호)입력                                                                             | 틀릴 경우 "아이디와 비밀번호가  맞는지 확인해주세요" 띄우기 맞을 경우 홈 화면으로 이동                          | 0        | 0          |   |
|                                 |                |                          | 비밀번호입력6                                                                                    |                                                                                                                 | 0        | 0          |   |
|                                 |                |                          | 비밀번호찾기                                                                                     | 아이디(전화번호)입력과 인증으로 새 비밀번호 설정가능                                                            | 0        | 0          |   |
|                                 | 사업자가입     |                          | 아이디인증                                                                                       | 아이디(전화번호)와 사업자인증                                                                                   | 0        | 0          |   |
|                                 |                |                          | 비밀번호설정                                                                                     | 조건 : 8자이상 영문 + 숫자 조합                                                                                 | 0        | 0          |   |
| 홈                              | 검색           | 알바추천                 | 검색어                                                                                           | 맞춤검색어추천                                                                                                  | 0        | 0          |   |
|                                 |                |                          | 카테고리검색                                                                                     | 알바유형별추천                                                                                                  | 0        | 0          |   |
|                                 | 내게딱맞는알바 |                          | 알바추천배너                                                                                     | 근처 대학생우대 알바추천                                                                                        | 0        | 0          |   |
|                                 | 최근지역공고   |                          | 최신알바                                                                                         | 최근 등록된 주변알바추천                                                                                        | 0        | 0          |   |
| 시간표                          | 연동하기       |                          | 부산대시간표와연동                                                                               | 수업시간이 파란색으로 표기됨                                                                                    | 0        | 0          |   |
|                                 | 수정           |                          | 추가/삭제                                                                                        | 연동된 시간표를 수정하거나 동아리/알바/기타 일정 등록 및 삭제                                                   | 0        | 0          |   |
|                                 | 맞춤알바추천   |                          | 한줄알바추천배너                                                                                 | 등록된 시간표를 기반으로시간표 하단에 한줄로맞춤알바추천                                                        | 0        | 0          |   |
| 마이페이지                      | 이력서         | 학생정보/편의            | 등록                                                                                             | 회원정보/학력/경력/개인정보이용동의 등 등록가능                                                                 | 0        | 0          |   |
|                                 |                |                          | 보기                                                                                             | 등록에서 입력한 정보를 수정 및 삭제가능, 본인사진 등록가능                                                      | 0        | 0          |   |
|                                 | 최근본         |                          | 최근본 알바배너                                                                                  | 최근본 알바 모아보기 / 선택지원 및 삭제가능                                                                     | 0        | 0          |   |
|                                 | 알림           |                          | 알림                                                                                             | 새로운 소식이나 안내, 정보 알림                                                                                 | 0        | 0          |   |
|                                 | 지원현황       |                          | 지원한 알바배너                                                                                  | 지원한 알바 모아보기 / 열람여부 확인가능                                                                        | 0        | 0          |   |
| 채용공고 (알바배너 클릭시 이동) | 근무조건       | 사업자 요구사항  및 조건 | 근무조건/모집조건/근무지역 등                                                                    | 급여, 근무기간, 요일, 시간, 장소 등의 조건들                                                                    | 0        | 0          |   |
|                                 | 상세요강       |                          | 상세한 근무지 정보와 사업자 요구사항 확인가능                                                    |                                                                                                                 | 0        | 0          |   |
|                                 | 기업정보       |                          | 공고를 낸 기업에 대한 정보와 인증 확인가능                                                       |                                                                                                                 | 0        | 0          |   |
|                                 | 지원하기       | 사업자와 연결            | 온라인 / 홈페이지 / 문자 / 전화 등 선택지원가능 온라인 지원의 경우 적어뒀던 이력서 불러오기 가능 |                                                                                                                 | 0        | 0          |   |
| 전체메뉴                        |                |                          | 여러가지 창들로 이동가능                                                                         |                                                                                                                 | 0        | 0          |   |
